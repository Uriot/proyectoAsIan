...
class SubcategoriasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            "Cables" => ["Adaptadores y Convertidores", "Cables Audio", "Cables para Celulares", "Cables computadoras", "Conectores", "Cables de Discos Duros", "Extensiones de Cables", "Cables de Impresoras", "Cables de Red", "Cables de Video", "Organizadores de Cables", "Baterías Cargadores y Powerbanks", "Ver todo"],
            ...
            "Teclados" => ["Accesorios para Teclados", "Teclados Bluetooth", "Teclados Ergonómicos", "Teclados Normales", "Teclados Multimedia", "Teclados Numéricos", "Teclados con Mouse Combos", "Ver todo"],
