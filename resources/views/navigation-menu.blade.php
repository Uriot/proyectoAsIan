    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                    ...
                    <div id="dropdownNavbar"
                        class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-56
        dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownNavbarLink">
                            ...
                            @foreach ($categorias as $categoria)
                                <li aria-labelledby="dropdownNavbarLink">
                                    <button id="dropdownSub{{ $categoria->id }}Button"
                                        data-dropdown-toggle="dropdownSub{{ $categoria->id }}"
                        ...
                        dark:hover:bg-gray-600 dark:hover:text-white">
                                    ...
                                    <!-- Subcategorías -->
                                    <div id="dropdownSub{{ $categoria->id }}"
                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-48
                        dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="dropdownSub{{ $categoria->id }}Button">
                                            @foreach ($categoria->subcategorias as $subcategoria)
                                                <li>
                                                    <a href="{{ route('dashboard') . '?id=' . $subcategoria->id }}"
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('misPedidos.index') }}">
                                {{ __('Mis Pedidos') }}
                            </x-dropdown-link>
